...
!!! Read input values for SPO model       
   ...
   if(spomod > 0) then
      ...
      if(spomod == 1 .and. ptmod == 0) then
         ...
         write(*,"(a)"),' STILWE with constant Cijs and Vmax from ../VIZTOMO/spo_input.dat'
      ...
      !!! DEM models
         ...
         write(*,"(a)"),' DEM with constant Cij, ellipsoid shape and Vmax from spo_input.dat'
         write(*,*)
         ...
         write(*,"(a)"),' DEM with Cij from LPO for matrix, constant Cij for inclusions, &
                         &ellipsoid shape and Vmax from spo_input.dat'
         write(*,*)
         ...
         write(*,"(a)"),' DEM with Cij from LPO for matrix, constant Cij for inclusions, &
                         &ellipsoid shape and melt content from geodynamic model'
         write(*,*)
         write(*,'(a,2f10.3)') ' Vamx, Vstp: ',Vmax,Vstp
         write(*,*)
         write(*,'(a,3f10.3)') ' FSE semiaxes max, med, min: ',esa   
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   SUBROUTINE stilwe(m,mtk1,mpgpa1,C1)              
   ...
   F = ((F00*(1.0-nnn)+F1*nnn)*(1.0-ee)+(F2*(1.0-nnn)+F3*nnn)*ee) 
