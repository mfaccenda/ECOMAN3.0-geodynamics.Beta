 ...
 !! ---------------------------------------------------------------------------
   ...
   ! Operating modes
   INTEGER :: texmod,fsemod,ptmod,fractdislmod,fabrictransformmod,uppermantlemod,eosmod,fossilfabric
   ! ODFTEX parameters and variables
   INTEGER :: nbox3,nbox,nboxnum
...
!!! Eulerian grid points - Velocity field - Temperature - Pressure - Fraction of dislocation creep
   ...
   INTEGER :: dimensions,cartspher,basicstag,x1periodic,x2periodic,x3periodic,yinyang
...
!!! Lagrangian grid - crystal aggregates   
   ...
   INTEGER(1), DIMENSION(:), ALLOCATABLE :: mdb !26062024
...
!   DOUBLE PRECISION, DIMENSION(:), ALLOCATABLE :: f1_ol,f1_opx
   DOUBLE PRECISION, DIMENSION(:,:,:,:), ALLOCATABLE :: pham,tham,psam,fm,fm_nodrx
   DOUBLE PRECISION, DIMENSION(:,:,:), ALLOCATABLE :: pha0,tha0,psa0,f0
