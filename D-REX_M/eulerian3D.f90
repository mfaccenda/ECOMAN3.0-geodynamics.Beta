...
!	----- +X
   ...
   if(isnan(l(tid,1,1))) print *,i1,i2,i3,tid,X1s,X2s,X3s,i1s,i2s,i3s,l(tid,1,1),y1,y2,y3,y4,y5,y6,y7,y8
...
!!! find the UPPER-LEFT grid point closest to the point of calculation
   ...
   !if(isnan(mx3(m))) print *,'ADVECTION ',m,mx1(m),mx2(m),mx3(m),dz,mx3(m)-dz
