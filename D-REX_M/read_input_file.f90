...
!  CHARACTER(200) :: str ! unused
   ...
   !Input files min,step,max, output frequency, max. time in
   ...
   if ( rankMPI .eq. 1 ) then
      ...
      write(*,*)
      if(Tinit == Tend) write(*,"(a,E14.3)")  ' Tinit = Tend --> steady-state flow for ',timemax
      write(*,*)
      write(*,"(a,f8.2)") ' Max. strain : ',strainmax
      write(*,*)
      write(*,"(a)") '--------------------------------------------------------'
      write(*,*)
   endif
